    ...
    <div className="App">
      ...
      <body className="App-body">
        ...
        <div className='controles'>
          ...
          <button type="button" className='boton botonStart' onClick={(e) => botonStart(e,estado,setEstado,setPosicionHporteria1,setPosicionHporteria2)} onKeyDown={(e) => flechasTeclado(e,posicionHjugador1,setPosicionHjugador1,posicionVjugador1,setPosicionVjugador1,posicionHbalon,setPosicionHbalon,posicionVbalon,setPosicionVbalon,posicionHjugadorCPU1,posicionVjugadorCPU1)} value="start"><FontAwesomeIcon icon={faPlayCircle}/></button>
